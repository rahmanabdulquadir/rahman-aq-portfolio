        ...
        <div className="lg:w-full flex flex-col lg:flex-row">
          ...
          >
            <div className="w-full flex flex-col justify-center lg:text-start text-center">
              ...
              <h2 className="text-[35px] lg:text-[90px] light-slate leading-none mb-12 font-code">
          ...
          <motion.form
            ...
            whileInView={"show"}
            viewport={{ once: true, amount: 0.3 }}
            className="lg:w-2/4 flex-1 border rounded-2xl flex flex-col justify-center gap-y-6 px-5 mx-7 py-12  items-start"
          >
            <input
