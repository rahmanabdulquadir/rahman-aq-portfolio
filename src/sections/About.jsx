...
const About = () => {
  return (
    <div className="" id="about">
      <div
        id="about"
        className="space-x-y mt-4   flex flex-col lg:flex-row items-center"
      >
        <div className="flex-1 slate lg:w-2/4 w-full lg:text-start text-center">
          ...
          <div>
            ...
            <p className="mb-6 text-2xl">
              Hey there, I am Rahman Abdul Quadir, a web developer with a twist
              of unconventional creativity.I have great interest in full-stack
              development, artificial intelligence, human-computer interactions,
              and everything in between. Apart from coding, I like to play
              games, listen music,reading books.
            </p>
        ...
        <div className="lg:w-2/4 w-full flex justify-center mt-10 lg:mt-0">
          <img
